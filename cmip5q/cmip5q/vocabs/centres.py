...
import uuid
CENTRES=(('NCAS','UK National Centre for Atmospheric Science',('HiGEM1.2')),
         ...
         ('UT-NIES,JAMESTEC','Center for Climate System Research (The University of Tokyo), National Institute for Environmental Studies, and Japan Agency for Marine-Earth Science and Technology',('MIROC4.2(M)','(MIRO4.2(H)','MIROC3.2(M)','MIROC-ESM')),
         ...
         ('CSIRO','Commonwealth Industrial and Scientific Organisation',('CSIRO-Mk3.5A')),
