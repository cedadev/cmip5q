...
from cmip5q.ControlledGrid import NumericalGrid
...
class gridHandler(object):
    ...
    def __init__(self,centre_id,grid_id=None):
        ...
        self.url=reverse('cmip5q.protoq.views.gridEdit',
    ...
    def copy(self,request):
        ...
        new.save()
        url=reverse('cmip5q.protoq.views.gridEdit',args=(self.centre_id,new.id,))
