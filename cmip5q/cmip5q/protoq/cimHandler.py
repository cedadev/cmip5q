...
from cmip5q.protoq.models import Simulation
from cmip5q.protoq.models import Component
...
def commonURLs(obj, dictionary):
    ...
    for key in ['validate', 'xml', 'cimView']:
        dictionary[key] = reverse('cmip5q.protoq.views.genericDoc',
                                  args=(obj.centre.id,
    ...
    if str(obj.centre) not in ['1. Example', '2. Test Centre', ]:
        dictionary['export'] = reverse('cmip5q.protoq.views.genericDoc',
                                       args=(obj.centre.id,
                                             obj._meta.module_name,
                                             obj.id,
                                             'export'))
