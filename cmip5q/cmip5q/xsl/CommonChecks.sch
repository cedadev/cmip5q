<schema xmlns="http://www.ascc.net/xml/schematron" xmlns:xsl="tmp.none">
     ...
     <pattern name="Check that every attribute has a value">
          ...
          <rule context="//CIMRecord//modelComponent/componentProperties/componentProperty/componentProperty">
               <assert test="string-length(value)>0">Attribute &quot;<value-of select="shortName"/>&quot; in component &quot;<value-of select="ancestor::modelComponent[1]/shortName"/>&quot; has no value.</assert>
          </rule>
     </pattern>
</schema>
